...
const { createOrUpdateTransaction, getTransactionByEmployeeCode, getAllTransactionData, combineEmployeeArrays, updateTransactionObject, updateObjectStatusAndResubmission, copyTransactionObjects } = require('../controllers/transactionController'); // Import the controller
